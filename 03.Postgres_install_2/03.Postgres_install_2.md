...
<summary><b>I.1 Условные обозначения</b></summary>
   ...
   2. Выполнение команд в рамках SSH-сессии на первой виртуальной машине

       <img src="images/bash_ico.png" height="32px" />

           vm:~$ do-something

   4. Выполнение команд в рамках SSH-сессии на первой виртуальной машине

       <img src="images/bash_2_ico.png" height="32px" />
...
5. С использованием утилиты psql создал тестовую таблицу с одним текстовым столбцом
...
9. Попробовал подмонтировать диск к директории `/mnt/postgres-data` и проверить сохранится ли настройка при перезагрузке виртуальной машины
    ...
    разрешение записи 
sudo chmod a+w /mnt/postgres-data
