...
Видим, что при таком типе нагрузки, когда сами запросы очень легкие, и процессор забит скорее количеством запросов и "инфраструктурной" нагрузкой на их обслуживание, а не долгой обработкой каждого из них, кластер Citus на машинах, где у каждого узла с сопоставимыми характеристиками как и у кластера с единым узлом, проигрывает в скорости обработки запросов единому узлу.
