...
<img src="images/powershell_ico.png" height="64px" /> Локальная машина

```powershell
PS local> do-something
```

<img src="images/bash_ico.png" height="64px" /> SSH подключение к виртуальной машине

```bash
vm:~$ do-something
```

<img src="images/psql_ico.png" height="64px" /> Работа в **psql**
