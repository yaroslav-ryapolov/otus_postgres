...
8. <a name="ii_8"> Создал папку на виртуальной машине для последующего хранения файлов PostgreSQL
...
16. Подключился к созданной ранее БД `otus` и запросил данные из таблицы `test`
   <img src="images/02.DataGrip_show_table_data.png" />
17. Чтобы проверить, что всю информацию наш кластер хранит в примонтированной на [шаге 9](#ii_9) директории [`/var/lib/postgresql`](##ii_2), остановил и удалил контейнер с кластером PostgreSQL
...
18. Занового запустил контейнер с кластером PostgreSQL
...
19. Снова запустил контейнер с утилитой `psql` в интерактивном режиме

    <img src="images/bash_ico.png" height="32px" />

        vm:~/pg-install$ docker compose run -i --rm pg-client

20. В открывшейся сессии **psql** подключился к БД `otus` и проверил наличие данных в таблице `test`
